...
// Defines taken from makefile to set SPI mode
// SPI SS
#define AVRSHOCK2_PORT_ATT PORTL
#define AVRSHOCK2_DDR_ATT DDRL
#define AVRSHOCK2_BIT_ATT PL0
// SPI MOSI
#define AVRSHOCK2_PORT_CMD PORTB
#define AVRSHOCK2_DDR_CMD DDRB
#define AVRSHOCK2_BIT_CMD PB3
// SPI MISO
#define AVRSHOCK2_PORT_DAT PORTB
#define AVRSHOCK2_DDR_DAT DDRB
#define AVRSHOCK2_PIN_DAT PINB
#define AVRSHOCK2_BIT_DAT PB2
// SPI SCK
#define AVRSHOCK2_PORT_CLK PORTB
#define AVRSHOCK2_DDR_CLK DDRB
#define AVRSHOCK2_BIT_CLK PB1

#define AVRSHOCK2_SPI
